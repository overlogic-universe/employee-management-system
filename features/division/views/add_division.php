...
<body>
    ...
    <div class="container">
        ...
        <div class="main" data-aos="fade-left">
            <div class="division-list">
                <h2>Divisions</h2>
                <form id="divisionForm" action="/add-division-process" method="POST">
                    <table>
                        <tr>
                            <td>Division Name </td>
                            <td width="5%">:</td>
                            <td width="75%"><input type="text" name="division_name" size="10" required></td>
                        </tr>
                    </table>
    ...
    <script>
        ...
        document.getElementById('divisionForm').addEventListener('submit', function(e) {
            ...
            Swal.fire({
                title: 'Are you sure?',
                text: "You're about to add a new division!",
                icon: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
                confirmButtonText: 'Yes, add division!'
            }).then((result) => {
